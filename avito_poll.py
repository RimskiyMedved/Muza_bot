...
def _load_state() -> None:
    ...
    global _greeted_chats, _last_handled, _msg_content, _awaiting_contact, _asked_date, _lead_received, _chat_context, _offered_alternatives, _faq_count, _stuck_notified
    try:
...
async def _process_chat(
    ...
    *,
    ...
    async def _save_contact(phone: str, nick: str) -> None:
        ...
        if known_date:
            ...
            auto_replies.append(
                "Скажите, пожалуйста, какую дату мероприятия рассматриваете? "
